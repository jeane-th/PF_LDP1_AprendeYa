<%-- 
    ...
    Created on : 27 dic. 2025, 19:14:13
    Author     : josueLady
--%>
...
<body class="bg-gray-900 text-white font-sans min-h-screen">
    ...
    <main class="max-w-7xl mx-auto py-12 px-6">
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="card bg-gray-800 border border-gray-700 hover:border-blue-600 transition transform hover:scale-105">
                <div class="card-body text-center">
                    <h2 class="text-2xl font-bold text-blue-400 mb-2">Configuración</h2>
                    <p class="text-gray-400 mb-4">Administra opciones generales del sistema.</p>
                    <a href="${pageContext.request.contextPath}/admin/configuracion"
                       class="btn bg-blue-600 hover:bg-blue-700 border-none">Configuración</a>
                </div>
            </div>
    ...
    <footer class="footer footer-center p-4 bg-gray-900 text-gray-500 border-t border-gray-800 mt-12">
        <p>© 2025 AprendeYa. Todos los derechos reservados.</p>
    </footer>
