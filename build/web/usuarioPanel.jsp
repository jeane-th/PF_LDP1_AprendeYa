<%-- 
    Document   : usuarioPanel
    Created on : 26 dic. 2025, 11:33:48 p. m.
    Author     : GamingWorld
--%>
    ...
    <body class="bg-base-300 min-h-screen">
        ...
        <div class="p-8 text-base-content max-w-[1400px] mx-auto">
            ...
            <div class="tabs tabs-boxed bg-transparent mb-8 gap-4 border-b border-white/10 rounded-none pb-0">
                ...
                <a href="${pageContext.request.contextPath}/usuarioPanel.jsp" class="tab tab-active text-primary border-b-2 border-primary font-bold bg-transparent">Usuarios</a>
                ...
                <table class="table w-full">
                    <thead class="bg-base-200/50 text-gray-400 font-semibold uppercase text-xs">
                        <tr>
                            ...
                            <th>Cursos</th> 
                            <th>Estado</th>
                            <th class="pr-6 text-center">Acciones</th>
                        </tr>
                    </thead>
                    <tbody class="text-sm" id="usersTableBody">
                        ...
                        <tr class="user-row hover:bg-white/5 border-b border-white/5 transition-colors" 
                            ...
                            <td class="pl-6 py-4"><%= u.getIdUsuario()%></td>
                            <td class="">
