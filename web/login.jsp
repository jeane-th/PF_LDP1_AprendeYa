            ...
            <section class="pb-8 pt-2 antialiased 
                ...
                <div class="sm:mt-10 max-w-9/10 p-5 sm:max-w-md  mx-auto rounded-lg border border-gray-200 shadow-sm 
                    ...
                    <form class="max-w-sm mx-auto" action="registro" method="post">
                        ...
                        <button type="submit" class="text-white bg-blue-600 box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-xl text-sm px-4 py-2.5 focus:outline-none w-full">Iniciar sesion</button>
                        <div class="pt-4 border-t border-gray-300 
                             border-gray-700 mt-4">
                            <p class=" text-sm font-medium text-gray-700 
                               text-white select-none h-6 w-full text-center">No tienes una cuenta <a href="login.jsp" class="text-blue-600 hover:underline">Registrate aquí </a>.</p>
                        </div>
