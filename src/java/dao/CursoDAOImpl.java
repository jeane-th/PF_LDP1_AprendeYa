    ...
    @Override
        public boolean eliminar(int idCurso) {
            ...
            try (Connection con = Conexion.getConnection()) {
                ...
                System.err.println(" Error al eliminar curso y sus reviews: " + e.getMessage());
                try {
